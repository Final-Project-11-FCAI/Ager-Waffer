...
String kEnter_first_name = "Enter_first_name";
String kEnter_last_name = "Enter_last_name";
String kfull_name_special_char = "full_name_special_char";
String kfull_name_validation = "full_name_validation";
...
String knoAccountKey = 'no_account';
String kcreateAccountNowKey = 'create_account_now';

String kCamera = 'camera';
String kGallery = 'gallery';
String kAddImage = 'add_image';
