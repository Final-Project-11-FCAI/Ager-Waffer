...
class PublicViewScreen extends StatelessWidget {
  ...
  // 2. بيانات المستخدم (الاسم، الموقع، النشاط)
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Gap(5.w),
              //Text("4.8 (15 تقييم)", style: font14GreyRegular),
              Text.rich(
                TextSpan(
                  children: [
                    TextSpan(
                    ...
                    TextSpan(text: "(15 تقييم) ", style: font14GreyRegular),
                  ],
                ),
              ),
            ],
          ...
          Gap(20.h),
          _buildInfoRow(Icons.location_on_outlined, "المحافظة", "القاهرة"),
          _buildInfoRow(
