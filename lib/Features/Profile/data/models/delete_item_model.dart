...
class DeleteItemModel extends BaseMappable{
  bool? isSuccess;
  bool? data;
  String? messageAr;
  String? messageEn;
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    messageEn = json['messageEn'];
    statusCode = json['statusCode'];
    return DeleteItemModel(isSuccess: isSuccess,data: data,messageAr: messageAr,messageEn: messageEn, statusCode: statusCode,);
  }
}