    ...
    return BlocBuilder<OrdersManagementBloc, OrdersManagementState>(
      builder: (context, state) {
        if (state.status == ordersManagementStatus.loading) {
          ...
          final currentOrdersManagement = ordersManagement.where((e) => e.status == "Approved").toList();
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Image.network(currentOrdersManagement[index].itemImages!.first,
                              width: 90.w,
                              height: 90.h,
                              fit: BoxFit.contain,
                            ),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Gap(5.w),
                                    Text(
                                      "المالك: ${currentOrdersManagement[index].renteeName}",
                                ...
                                Row(
                                  children: [
                                    ...
                                    Gap(5.w),
                                    Text(
                                      '${currentOrdersManagement[index].fromDate!} - ${currentOrdersManagement[index].toDate!}',
                                ...
                                Row(
                                  children: [
                                    ...
                                    Gap(5.w),
                                    Text(
                                      ' متبقي ${currentOrdersManagement[index].timeLeftInDays.toString() ?? ''} يوم',
                                      style: font20PrimaryMedium.copyWith(
                                        fontSize: 13.sp,
                                        color: kOrangeColor,
                                      ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              currentOrdersManagement[index].totalPrice.toString(),
