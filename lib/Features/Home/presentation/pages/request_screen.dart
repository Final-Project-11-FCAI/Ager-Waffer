...
class _RequestScreenState extends State<RequestScreen> {
  ...
  double get totalPrice {
    ...
    if (widget.product.rentUnit == "Weekly" || widget.product.rentUnit == "أسبوعي") {
      return periodCount * widget.product.price!;
    }

    if (widget.product.rentUnit == "Monthly" || widget.product.rentUnit == "شهري") {
      return periodCount * widget.product.price!;
    }
  ...
  void updateEndDate() {
    ...
    bool isWeekly = widget.product.rentUnit == "Weekly" ||
        widget.product.rentUnit == "أسبوعي";
    bool isMonthly = widget.product.rentUnit == "Monthly" ||
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: BlocListener<SendRequestBloc, SendRequestState>(
                        ...
                        child: Column(
                          ...
                          children: [
                                            ...
                                            ...List.generate(
                                              5,
                                                  ...
                                                  Icon(
                                                    ...
                                                    size: 14.sp,
                                                    color:
                                                    index < widget.product.averageRate!.floor() ? Colors.amber : Colors.grey.shade300,
                                                  ),
                                            ),
                                          ],
                                        ),
                                      ...
                                      children: [
                                        Text(
                                          widget.product.rentUnit == "Weekly" ||
                                              widget.product.rentUnit ==
                                                  "أسبوعي"
                                              ? kNumberOfWeeks.tr() : kNumberOfMonths.tr(),
                                          style: font15SomeBlackColorMedium
                                              .copyWith(
                                            color: isDark ? kWhiteColor : kgreyColor,
                                          ),
                            ...
                            Container(
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(24),
                                color: isDark ? kSomeDarkModeColor : Color
                                    .fromARGB(
                                    255, 240, 240, 240),
                              ),
                              child: Padding(
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: isDark ? kSomeDarkModeColor : Colors.grey.shade100,
                                borderRadius: BorderRadius.circular(16.r),
                                border: Border.all(
                                    color: isDark ? kWhiteColor.withOpacity(0.4) : Colors.grey.shade300),
                              ),
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                    ...
                                    child: RichText(
                                      text: TextSpan(
                                        style: font15SomeBlackColorMedium
                                            .copyWith(
                                          fontSize: 14,
                                          color: isDark ? kWhiteColor : Colors
                                              .black87,
                                        ),
                                        children: [
                                          TextSpan(
                                            ...
                                            child: GestureDetector(
                                              ...
                                              child: Text(
                                                ...
                                                style: font14BlackBold.copyWith(
                                                  ...
                                                  decorationColor: isDark ? kWhiteColor : kBlackColor,
                                                  fontSize: 15,
                                                ),
                                              ),
                                            ),
