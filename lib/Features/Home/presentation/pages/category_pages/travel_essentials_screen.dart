...
class TravelEssentialsScreen extends StatefulWidget {
  const TravelEssentialsScreen({super.key});

  @override
  State<TravelEssentialsScreen> createState() => _TravelEssentialsScreenState();
}

class _TravelEssentialsScreenState extends State<TravelEssentialsScreen> {
