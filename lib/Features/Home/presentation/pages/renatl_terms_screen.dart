...
class _RentalTermsScreenState extends State<RentalTermsScreen> {
  ...
  Widget _buildTermItem(int index) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Image.asset('assets/images/terms_icon.png',color: isDark ? kGreyColor : kPrimaryColor,),
          Gap(5.w),
          Expanded(
            child: Text(
              terms[index],
              style: font20PrimaryMedium.copyWith(fontSize: 16,color: isDark ? kGreyColor : kPrimaryColor),
            ),
          ),
        ],
      ),
