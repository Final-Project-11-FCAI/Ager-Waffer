                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              CachedNetworkImage(
                                imageUrl: currentOrders[index].itemImages!
                                    .first,
                                width: 90.w,
                                height: 90.h,
                                fit: BoxFit.contain,
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        "${kRemaining
                                            .tr()} ${currentOrders[index]
                                            .timeLeftInDays} ${kDays.tr()}",
                                        style: font20PrimaryMedium.copyWith(
                                          fontSize: 13.sp,
                                          color: kOrangeColor,
                                        ),
                                    ...
                                    customAnimatedPushNavigation(
                                      ...
                                      ChatScreen(
                                        ...
                                        chatUser: ChatUser(
                                          ...
                                          image: currentOrders[index]
                                              .itemImages![0],
                                          about: "Hello I'm ${currentOrders[index]
                                              .ownerName}",
        ...
        child: Row(
          ...
          children: [
            isNotIcon ? SizedBox() : Image.asset(
                icon, color: isDark ? kTextColor : kPrimaryColor,
                width: 20.w,
                height: 20.h),
            Gap(5),
            Text(
